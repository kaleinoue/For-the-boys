...
> 🔋 **Jyana (Engine):** relentless brute-forcing is your lane — spam weird inputs, mash every key, hold every button, feed the game a hundred wrong values and try it a hundred wrong ways until something breaks. Raw energy finds bugs that patience misses; you'll out-last everyone hammering your own agent and your own game (your stuff only — keep the white hat on). When you're not sure what to attack next, that's the cue: get one clear target from the crew, then floor it.
